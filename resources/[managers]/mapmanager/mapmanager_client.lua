...
AddEventHandler('onClientResourceStart', function(res)
    ...
    -- defer this to the next game tick to work around a lack of deps
    Hyperion.CreateThread(function()
        Hyperion.Wait(15)
...
AddEventHandler('getMapDirectives', function(add)
    ...
    end, function(state, args)
        Hyperion.Trace("deleting car gen " .. tostring(state.cargen) .. "\n")
