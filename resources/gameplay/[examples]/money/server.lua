local playerData = exports['crash/playerData.v1alpha1']
...
AddEventHandler('money:updated', function(data)
    if data.source then
        TriggerClientEvent('money:displayUpdate')
    end
end)
...
RegisterCommand('earn', function(source, args)
    ...
    exports['money']:addMoney(source, types, amount)
end, true)
