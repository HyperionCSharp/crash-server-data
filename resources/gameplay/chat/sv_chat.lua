...
RegisterServerEvent('__crash_internal:commandFallback')
...
ocal function unregisterHooks(resource)
    local toRemove = {}
...
AddEventHandler('__crash_internal:commandFallback', function(command)
